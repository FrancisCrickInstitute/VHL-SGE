...
#arguments -- [1], input file (designed to be anything pre or post merger);  [2], output file (will be an unzipped fastq) [3] 
...
cDNA_info_file = open(sys.argv[3],'r') #tab-delimited file with header
